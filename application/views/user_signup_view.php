...
<body>
		...
		<?php echo '点击'.anchor('home','这里').'返回主界面'?>
		
		<?php echo form_open('sign_up/sign') ?>
		
			<p>邮箱：<?php echo form_input('email') ?></p>
			<p>密码：<?php echo form_password('password') ?><p>
			<p>确认：<?php echo form_password('password2') ?></p>
			<p>绰号：<?php echo form_input('name') ?></p>
			<p>姓名：<?php echo form_input('name2') ?></p>
