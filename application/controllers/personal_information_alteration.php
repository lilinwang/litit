...
class Personal_information_alteration extends CI_Controller {
	...
	function index(){
	    if($this->session->userdata('usertype') == '1'){
            ...
            $this->load->view('personal_information_alteration',$data);
		}else{
            ...
            $this->load->view('personalm_information_alteration',$data);
